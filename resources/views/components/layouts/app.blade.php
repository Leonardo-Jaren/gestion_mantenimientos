    ...
    <div class="min-h-screen">
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-white shadow-lg transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
            ...
            <nav class="mt-8 px-4 space-y-2">
                ...
                <a wire:navigate href="/configuracion" class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-indigo-100 hover:text-indigo-700 {{ request()->is('configuracion*') ? 'bg-indigo-100 text-indigo-700' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
