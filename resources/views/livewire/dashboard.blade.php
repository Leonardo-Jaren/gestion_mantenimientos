    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-{{ auth()->user()->rol === 'Administrador' ? 'red' : (auth()->user()->rol === 'Supervisor' ? 'yellow' : 'green') }}-100 text-{{ auth()->user()->rol === 'Administrador' ? 'red' : (auth()->user()->rol === 'Supervisor' ? 'yellow' : 'green') }}-800">
                    {{ auth()->user()->rol }}
                </span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $stats['equipos_total'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $stats['equipos_activos'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $stats['mantenimientos_pendientes'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Órdenes Abiertas</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $stats['ordenes_abiertas'] }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
                ...
                <div class="text-left">
                    <p class="font-medium text-gray-900">Nuevo Equipo</p>
            ...
            >
                ...
                <div class="text-left">
                    <p class="font-medium text-gray-900">Programar Mantenimiento</p>
                    <p class="text-sm text-gray-600">Nueva orden</p>
                </div>
            </button>
            ...
            >
                ...
                <div class="text-left">
                    ...
                    <p class="text-sm text-gray-600">Estadísticas</p>
                </div>
            </button>
            ...
            >
                ...
                <div class="text-left">
                    ...
                    <p class="text-sm text-gray-600">Gestionar stock</p>
                </div>
            </button>
        </div>
    </div>
